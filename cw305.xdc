...
set_property PACKAGE_PIN C14 [get_ports ro_enable_out]

set_property PACKAGE_PIN A13 [get_ports bank0_out]

set_property PACKAGE_PIN E13 [get_ports uart_rxd_i]

set_property PACKAGE_PIN E15 [get_ports uart_txd_o]

set_property PACKAGE_PIN E16 [get_ports bootloader]
...
set_input_delay -clock usb_clk -add_delay 0.000 [get_ports uart_rxd_i]
...
set_output_delay -clock usb_clk 0.000 [get_ports ro_enable_out]
set_output_delay -clock usb_clk 0.000 [get_ports bank0_out]
set_output_delay -clock usb_clk 0.000 [get_ports uart_txd_o]
set_output_delay -clock usb_clk 0.000 [get_ports bootloader]
...
set_false_path -to [get_ports ro_enable_out]
set_false_path -to [get_ports bank0_out]
set_false_path -to [get_ports uart_txd_o]
set_false_path -to [get_ports bootloader]
...
# MODIFICATION: allowing combinatorial logic loops for ring oscillator design
# Target the actual wires ('osc') instead of the generate block name
set_property ALLOW_COMBINATORIAL_LOOPS TRUE [get_nets -hier -filter {NAME =~ *osc*}]